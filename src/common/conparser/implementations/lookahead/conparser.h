...
#endif
    std::vector<std::vector<int> > m_extra_left;
    std::vector<std::vector<int> > m_extra_right;
    std::vector<std::vector<int> > m_extra_head;

    std::vector<std::vector<int> > m_extra_left_rank;
    std::vector<std::vector<int> > m_extra_right_rank;
    std::vector<std::vector<int> > m_extra_head_rank;
    
public:
   // constructor and destructor
    double parse_time;
    double extra_parse_time;
    unsigned long fire;
    unsigned long extra_fire;
...
public:
   void setExtra(const std::vector<std::vector<std::string> > &extra);
