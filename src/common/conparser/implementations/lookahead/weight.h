...
\
   left(m_mapS0lcd)right\
   left(m_mapS1lcd)right\
\
   left(m_mapS0rcd)right\
   left(m_mapS1rcd)right\
\
   left(m_mapN0lcd)right\
   left(m_mapN1lcd)right\
\
   left(m_mapN0rcd)right\
   left(m_mapN1rcd)right\
\
   left(m_mapN0have)right\
   left(m_mapN1have)right\
   left(m_mapN2have)right\
   left(m_mapN3have)right
...
\
   left m_mapS0lcd middle m_mapS0lcd right\
   left m_mapS1lcd middle m_mapS1lcd right\
\
   left m_mapS0rcd middle m_mapS0rcd right\
   left m_mapS1rcd middle m_mapS1rcd right\
\
   left m_mapN0lcd middle m_mapN0lcd right\
   left m_mapN1lcd middle m_mapN1lcd right\
\
   left m_mapN0rcd middle m_mapN0rcd right\
   left m_mapN1rcd middle m_mapN1rcd right\
\
   left m_mapN0have middle m_mapN0have right\
   left m_mapN1have middle m_mapN1have right\
   left m_mapN2have middle m_mapN2have right\
   left m_mapN3have middle m_mapN3have right
...
typedef CScoreMapType<bool, SCORE_TYPE, CAction::MAX> CBoolMap;
...
public:
   ...
   CConstituentMap m_mapS0lcd;
   CConstituentMap m_mapS1lcd;

   CConstituentMap m_mapS0rcd;
   CConstituentMap m_mapS1rcd;

   CConstituentMap m_mapN0lcd;
   CConstituentMap m_mapN1lcd;

   CConstituentMap m_mapN0rcd;
   CConstituentMap m_mapN1rcd;
   
   CBoolMap m_mapN0have;
   CBoolMap m_mapN1have;
   CBoolMap m_mapN2have;
   CBoolMap m_mapN3have;
public:
   ...
   CWeight(bool bTrain, unsigned TABLE_SIZE = DEFAULT_TABLE_SIZE) : 
			  ...
			  m_mapS0lcd("Stack0LeftConstituentDistribution", TABLE_SIZE),
			  m_mapS1lcd("Stack1LeftConstituentDistribution", TABLE_SIZE),

                          m_mapS0rcd("Stack0RightConstituentDistribution", TABLE_SIZE),
                          m_mapS1rcd("Stack1RightConstituentDistribution", TABLE_SIZE),

			  m_mapN0lcd("Next0LeftConstituentDistribution", TABLE_SIZE),
			  m_mapN1lcd("Next1LeftConstituentDistribution", TABLE_SIZE),

                          m_mapN0rcd("Next0RightConstituentDistribution", TABLE_SIZE),
                          m_mapN1rcd("Next1RightConstituentDistribution", TABLE_SIZE),
			 
			  m_mapN0have("Next0have", TABLE_SIZE),
                          m_mapN1have("Next1have", TABLE_SIZE),
                          m_mapN2have("Next2have", TABLE_SIZE),
			  m_mapN3have("Next3have", TABLE_SIZE)
   {}
   ~CWeight() {
