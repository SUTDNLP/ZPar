...
enum STACK_ACTION { NO_ACTION=0, SHIFT, REDUCE, ARC_LEFT, ARC_RIGHT, POP_ROOT, LABEL_AL_FIRST, LABEL_AR_FIRST=LABEL_AL_FIRST+DEP_LABEL_COUNT-1, LABEL_SH_FIRST=LABEL_AR_FIRST+DEP_LABEL_COUNT-1, MAX=LABEL_SH_FIRST+POS_LABEL_COUNT-1 };
